...
namespace LoginProject.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [RegularExpression("([1-9][0-9]*)", ErrorMessage = "Postcode must contain only numbers")]
            [StringLength(4, ErrorMessage = "Postcode should contain 4 characters")]
            public string Postcode { get; set; }

            [Required]
            [RegularExpression("^(\\+?\\(61\\)|\\(\\+?61\\)|\\+?61|\\(0[1-9]\\)|0[1-9])?( ?-?[0-9]){7,9}$", ErrorMessage = "Field must contain an Australian phone number")]
